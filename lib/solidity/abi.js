...
const arc20List = require('./arc20-abi.json')
const arc721List = require('./arc721-abi.json')
...
const arc20ABIs = transformABIList(arc20List)
const arc721ABIs = transformABIList(arc721List)

Object.assign(exports, {MethodABI, EventABI, arc20ABIs, arc721ABIs})
